...
int test_eo_geometry()
{
  ...
  paste_eo_parts_into_lx_vector((char*)(lx_conf_reco),(char*)(eo_conf[0]),(char*)eo_conf[1],loc_vol+loc_bord+loc_edge,sizeof(quad_su3));
  ...
  master_printf("lx plaquette: %16.16lg, eo comp %16.16lg, reconstructed: %16.16lg\n",plaq_lx,plaq_eo,plaq_reco);
