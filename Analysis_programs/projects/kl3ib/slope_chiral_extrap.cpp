...
int main(int narg,char **arg)
{
  ...
  //setup the plot
  grace outh("slope_chiral_extrap.xmg");
  outh.plot_size(800,600);
  outh.plot_title("Chiral extrapolation of (a\\xD\\0M\\N\\sK\\N)\\S2");
  outh.axis_label("(aM\\s\\xp\\N)\\S2","(a\\xD\\0M\\N\\sK\\N)\\S2");
  //plot the function with error
  outh.set(1,"orange");
  jvec par(2,njack);par.data[0]=-m;par.data[1]=-q;
  outh.polygon(lin_fun,0,X[nel-1]*1.1,100,par);
