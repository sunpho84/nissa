...
int main()
{
  ...
  for(int iens=0;iens<nens;iens++)
      ...
      for(int ims=0;ims<nmass[iens];ims++)
	{
      ...
      bvec X_charm=interpolate_charm(X,nmass[iens],nlights[iens],mass[iens],ibeta[iens]);
      Xint.data[iens]=X_charm[iml_un[iens]];
      
      cout<<(mass[iens][iml_un[iens]]/lat[ibeta[iens]]/Zp[ibeta[iens]]).med()<<" "<<Xint[iens]<<endl;
    }
  
  Xint.write_to_binfile("interpolated_M_D_ratdiff_V_PS");
