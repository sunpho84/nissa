...
int main(int narg,char **arg)
{
  ...
  boot M2K_chir_cont(nboot,njack);
  ...
  for(int ib=0;ib<nbeta;ib++)
      ...
      for(int iboot=0;iboot <nboot+1;iboot++)
	{
	  ...
	  M2K_chir_cont.data[iboot]=fun_fit_M2K(A[iboot],B[iboot],C[iboot],ml_phys[iboot],0);
	  MK_chir_cont.data[iboot]=sqrt(M2K_chir_cont.data[iboot]);
