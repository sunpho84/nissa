...
int main(int narg,char **arg)
{
  ...
  char ens_list_path[1024],meson_P5P5_file[1024],meson_S0S0_file[1024],meson_name[1024];
  ...
  read_formatted_from_file_expecting(meson_S0S0_file,an_input_file,"%s","meson_mass_S0S0_file");
  ...
  bvec cS0S0(nens,nboot,njack);
  cS0S0.load(meson_S0S0_file,0);
  diff=cS0S0-cP5P5;
