		...
		TmQuarkInfo qu)
{
  ...
  complex* c=new complex[glbSize[0]];
...
void bar_contr_free(complex *mess,TmQuarkInfo qu)
{
  ...
  complex* co=new complex[glbSize[0]];
...
void check_handcuffs()
{
  ...
  complex* co_f_co=new complex[glbSize[0]];
