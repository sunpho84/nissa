...
#define ANTIPERIODIC_BC 1
  ...
  const char ins_tag[nins_kind][INS_TAG_MAX_LENGTH+1]=    {"-"   ,"S"     ,"P"     ,"F"     ,"A"         ,"C"         ,"T"      ,"V"   ,"V0"   ,"V0B"  ,"V0F"  ,"V1"   ,"V2"   ,"V3"   ,"F0"     ,"F1"     ,"F2"     ,"F3"     ,"VF0"     ,"VF1"     ,"VF2"     ,"VF3"     ,"VB0"     ,"VB1"     ,"VB2"     ,"VB3"     ,"WF"   ,"BF"       ,"SM"     ,"AN"     ,"PH"     ,"X"    ,"G"    ,"COL"    ,"DOP"  ,"DEL_POS"  ,"DEL_SPIN"  ,"DEL_COL"  ,"LEP_LOOP"  , "COV_DER"};
  inline insertion_t insFromName(const char *tag)
  {
    int i=0;
