...
gluon_info create_tlSym_gluon_info(double alphppa,momentum_t bc,double c1=-1.0/12,double zmp=0);
gluon_info create_Wilson_gluon_info(double alphppa,momentum_t bc,double zmp=0);
