...
#define DEFINE_STAGGERED_HOPPING_MATRIX(PREC,PREC_TYPE,BI_32_64_OCT_SU3_T,BI_32_64_COLOR_T) \
  ...
  void NAME3(hopping_matrix_eo_or_eo_expand_to,PREC,staggered_D_subtract_from_mass2_times_in)(BI_32_64_COLOR_T *out,PREC_TYPE mass2,BI_32_64_COLOR_T *in); \
  void NAME3(hopping_matrix_eo_or_eo_expand_to,PREC,staggered_D)(BI_32_64_COLOR_T *out); \
  void NAME3(hopping_matrix_eo_or_eo_expand_to,PREC,staggered_D)(BI_32_64_COLOR_T *out,double coeff);
