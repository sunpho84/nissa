...
namespace nissa
{
  inline void unsafe_vir_halfspincolor_halfspincolor_times_vir_halfspincolor(vir_halfspincolor out,vir_halfspincolor_halfspincolor invCl,vir_halfspincolor in)
  {
      ...
      for(int ic=0;ic<NCOL;ic++)
	{
	  ...
	  VIR_COMPLEX_PROD(REG_OUT,M_s0_c0,REG_IN_s0_c0);
	  VIR_COMPLEX_SUMM_THE_PROD(REG_OUT,M_s0_c1,REG_IN_s0_c1);
	  VIR_COMPLEX_SUMM_THE_PROD(REG_OUT,M_s0_c2,REG_IN_s0_c2);
	  VIR_COMPLEX_SUMM_THE_PROD(REG_OUT,M_s1_c0,REG_IN_s1_c0);
	  VIR_COMPLEX_SUMM_THE_PROD(REG_OUT,M_s1_c1,REG_IN_s1_c1);
	  VIR_COMPLEX_SUMM_THE_PROD(REG_OUT,M_s1_c2,REG_IN_s1_c2);
  ...
  inline void unsafe_vir_halfspincolor_halfspincolor_dag_times_vir_halfspincolor(vir_halfspincolor out,vir_halfspincolor_halfspincolor invCl,vir_halfspincolor in)
  {
      ...
      for(int ic=0;ic<NCOL;ic++)
	{
	  ...
	  VIR_COMPLEX_SUMM_THE_CONJ1_PROD(REG_OUT_s0_c0,M_s0_c0,REG_IN);
	  VIR_COMPLEX_SUMM_THE_CONJ1_PROD(REG_OUT_s0_c1,M_s0_c1,REG_IN);
	  VIR_COMPLEX_SUMM_THE_CONJ1_PROD(REG_OUT_s0_c2,M_s0_c2,REG_IN);
	  VIR_COMPLEX_SUMM_THE_CONJ1_PROD(REG_OUT_s1_c0,M_s1_c0,REG_IN);
	  VIR_COMPLEX_SUMM_THE_CONJ1_PROD(REG_OUT_s1_c1,M_s1_c1,REG_IN);
	  VIR_COMPLEX_SUMM_THE_CONJ1_PROD(REG_OUT_s1_c2,M_s1_c2,REG_IN);
	}
