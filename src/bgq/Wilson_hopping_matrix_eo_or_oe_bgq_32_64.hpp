...
#include "bgq_macros.hpp"
 ...
 #define BI_32_64_HALFSPINCOLOR bi_halfspincolor
 #define BI_32_64_SPINCOLOR bi_spincolor
...
#define APPLY_32_64_WILSON_HOPPING_MATRIX_OE_OR_EO_BGQ_NOCOMM	\
 ...
 #define REG_LOAD_BI_32_64_SPINCOLOR_ADVANCING REG_LOAD_BI_SPINCOLOR_ADVANCING
 #define REG_LOAD_BI_32_64_SPINCOLOR REG_LOAD_BI_SPINCOLOR
 #define REG_LOAD_BI_32_64_HALFSPINCOLOR REG_LOAD_BI_HALFSPINCOLOR
 #define STORE_REG_BI_32_64_SPINCOLOR STORE_REG_BI_SPINCOLOR
 #define STORE_REG_BI_32_64_SPINCOLOR_ADVANCING STORE_REG_BI_SPINCOLOR_ADVANCING
 #define STORE_REG_BI_32_64_HALFSPINCOLOR STORE_REG_BI_HALFSPINCOLOR
 #define BI_32_64_HALFSPINCOLOR_PREFETCH_NEXT BI_HALFSPINCOLOR_PREFETCH_NEXT
 #define REG_BI_32_64_SU3_PROD_BI_32_64_HALFSPINCOLOR_LOAD_STORE REG_BI_SU3_PROD_BI_HALFSPINCOLOR_LOAD_STORE
 #define REG_BI_32_64_SU3_DAG_PROD_BI_32_64_HALFSPINCOLOR_LOAD_STORE REG_BI_SU3_DAG_PROD_BI_HALFSPINCOLOR_LOAD_STORE
 ...
 #define BI_32_64_HALFSPINCOLOR bi_single_halfspincolor
 #define BI_32_64_SPINCOLOR bi_single_spincolor
...
#define APPLY_32_64_WILSON_HOPPING_MATRIX_OE_OR_EO_BGQ_NOCOMM	\
 ...
 #define REG_LOAD_BI_32_64_SPINCOLOR_ADVANCING REG_LOAD_BI_SINGLE_SPINCOLOR_ADVANCING
 #define REG_LOAD_BI_32_64_SPINCOLOR REG_LOAD_BI_SINGLE_SPINCOLOR
 #define REG_LOAD_BI_32_64_HALFSPINCOLOR REG_LOAD_BI_SINGLE_HALFSPINCOLOR
 #define STORE_REG_BI_32_64_SPINCOLOR STORE_REG_BI_SINGLE_SPINCOLOR
 #define STORE_REG_BI_32_64_SPINCOLOR_ADVANCING STORE_REG_BI_SINGLE_SPINCOLOR_ADVANCING
 #define STORE_REG_BI_32_64_HALFSPINCOLOR STORE_REG_BI_SINGLE_HALFSPINCOLOR
 #define BI_32_64_HALFSPINCOLOR_PREFETCH_NEXT BI_SINGLE_HALFSPINCOLOR_PREFETCH_NEXT
 #define REG_BI_32_64_SU3_PROD_BI_32_64_HALFSPINCOLOR_LOAD_STORE REG_BI_SINGLE_SU3_PROD_BI_SINGLE_HALFSPINCOLOR_LOAD_STORE
 #define REG_BI_32_64_SU3_DAG_PROD_BI_32_64_HALFSPINCOLOR_LOAD_STORE REG_BI_SINGLE_SU3_DAG_PROD_BI_SINGLE_HALFSPINCOLOR_LOAD_STORE
...
namespace nissa
{
  ...
  THREADABLE_FUNCTION_1ARG(HOPPING_MATRIX_OE_OR_EO_EXPAND_TO_32_64_WILSON_2D, BI_32_64_SPINCOLOR*,out)
  {
    GET_THREAD_ID();
    
    //result of split application
    BI_32_64_HALFSPINCOLOR *bgq_hopping_matrix_output_data=(BI_32_64_HALFSPINCOLOR*)send_buf+bord_volh/2;
    ...
    for(int i=start;i<end;i++)
      {
	BI_32_64_HALFSPINCOLOR *piece=bgq_hopping_matrix_output_data+i*8;
	
	DECLARE_REG_BI_SPINCOLOR(reg_out);
	REG_SPLAT_BI_SPINCOLOR(reg_out,0.0);
	...
	//store
        STORE_REG_BI_32_64_SPINCOLOR(&(out[i]),reg_out);
      }
  ...
  THREADABLE_FUNCTION_5ARG(APPLY_32_64_WILSON_HOPPING_MATRIX_OE_OR_EO_BGQ_NOCOMM, BI_32_64_OCT_SU3**,conf, int,istart, int,iend, BI_32_64_SPINCOLOR*,in, int,oe_or_eo)
  {
    GET_THREAD_ID();
    
    BI_32_64_HALFSPINCOLOR *out=(BI_32_64_HALFSPINCOLOR*)send_buf;
	...
	BI_32_64_SU3 *links=(BI_32_64_SU3*)(conf[oe_or_eo]+i);
	...
	REG_LOAD_BI_32_64_SPINCOLOR(reg_in,in[i]);
        ...
        REG_BI_32_64_SU3_PROD_BI_32_64_HALFSPINCOLOR_LOAD_STORE(out[iout[0]],links[0],reg_proj);
        ...
        REG_BI_32_64_SU3_PROD_BI_32_64_HALFSPINCOLOR_LOAD_STORE(out[iout[1]],links[1],reg_proj);
        ...
        REG_BI_32_64_SU3_PROD_BI_32_64_HALFSPINCOLOR_LOAD_STORE(out[iout[2]],links[2],reg_proj);
        ...
        REG_BI_32_64_SU3_PROD_BI_32_64_HALFSPINCOLOR_LOAD_STORE(out[iout[3]],links[3],reg_proj);
        ...
        REG_BI_32_64_SU3_DAG_PROD_BI_32_64_HALFSPINCOLOR_LOAD_STORE(out[iout[4]],links[4],reg_proj);
        ...
        REG_BI_32_64_SU3_DAG_PROD_BI_32_64_HALFSPINCOLOR_LOAD_STORE(out[iout[5]],links[5],reg_proj);
        ...
        REG_BI_32_64_SU3_DAG_PROD_BI_32_64_HALFSPINCOLOR_LOAD_STORE(out[iout[6]],links[6],reg_proj);
  ...
  THREADABLE_FUNCTION_0ARG(BGQ_32_64_WILSON_HOPPING_MATRIX_OE_OR_EO_VDIR_VN_COMM_AND_BUFF_FILL)
  {
      ...
      NISSA_CHUNK_LOOP(base_isrc,0,vbord_vol/4/fact,thread_in_team_id,nthreads_in_team)
	{
	  ...
	  REG_LOAD_BI_32_64_HALFSPINCOLOR(in0,bgq_hopping_matrix_output_vdir_buffer[isrc]);
	  //load the second
	  DECLARE_REG_BI_HALFSPINCOLOR(in1);
	  REG_LOAD_BI_32_64_HALFSPINCOLOR(in1,bgq_hopping_matrix_output_vdir_buffer[isrc+1]);
	  //merge the two and save
	  DECLARE_REG_BI_HALFSPINCOLOR(to_buf);
	  REG_BI_HALFSPINCOLOR_V0_MERGE(to_buf,in0,in1);
	  STORE_REG_BI_32_64_HALFSPINCOLOR(((BI_32_64_HALFSPINCOLOR*)send_buf)[idst_buf],to_buf);
	}
  ...
  THREADABLE_FUNCTION_0ARG(BGQ_32_64_WILSON_HOPPING_MATRIX_OE_OR_EO_VDIR_VN_LOCAL_TRANSPOSE)
  {
    ...
    const int fact=2;
    int v=vnode_paral_dir;
    BI_32_64_HALFSPINCOLOR *bgq_hopping_matrix_output_vdir_buffer=(BI_32_64_HALFSPINCOLOR*)send_buf+bord_volh/fact+8*loc_volh/fact;
    
    FORM_TWO_THREAD_TEAMS();
    
    //backward scatter (forward derivative)
    BI_32_64_HALFSPINCOLOR *base_out_bw=(BI_32_64_HALFSPINCOLOR*)send_buf+(bord_volh+1*8*vdir_bord_vol)/fact;
    BI_32_64_HALFSPINCOLOR *base_in_bw=bgq_hopping_matrix_output_vdir_buffer+0*vdir_bord_vol/fact;
    if(is_in_first_team)
      NISSA_CHUNK_LOOP(isrc,0,vdir_bord_vol/fact,thread_in_team_id,nthreads_in_team)
	{
	  //load
	  DECLARE_REG_BI_HALFSPINCOLOR(reg_in);
	  REG_LOAD_BI_32_64_HALFSPINCOLOR(reg_in,base_in_bw[isrc]);
	  //transpose and store
	  DECLARE_REG_BI_HALFSPINCOLOR(reg_out);
	  REG_BI_HALFSPINCOLOR_TRANSPOSE(reg_out,reg_in);
	  STORE_REG_BI_32_64_HALFSPINCOLOR(base_out_bw[isrc*8+0+v],reg_out);
	}
    
    //forward scatter (backward derivative)
    BI_32_64_HALFSPINCOLOR *base_out_fw=(BI_32_64_HALFSPINCOLOR*)send_buf+(bord_volh+0*8*vdir_bord_vol)/fact;  
    BI_32_64_HALFSPINCOLOR *base_in_fw=bgq_hopping_matrix_output_vdir_buffer+1*vdir_bord_vol/fact;
    if(is_in_second_team)
      NISSA_CHUNK_LOOP(isrc,0,vdir_bord_vol/fact,thread_in_team_id,nthreads_in_team)
	{
	  //load
	  DECLARE_REG_BI_HALFSPINCOLOR(reg_in);
	  REG_LOAD_BI_32_64_HALFSPINCOLOR(reg_in,base_in_fw[isrc]);
	  //transpose and store
	  DECLARE_REG_BI_HALFSPINCOLOR(reg_out);
	  REG_BI_HALFSPINCOLOR_TRANSPOSE(reg_out,reg_in);
	  STORE_REG_BI_32_64_HALFSPINCOLOR(base_out_fw[isrc*8+4+v],reg_out);
	}
  ...
  THREADABLE_FUNCTION_1ARG(FINISH_32_64_WILSON_HOPPING_MATRIX_OE_OR_EO_BGQ_COMMUNICATIONS, int,oe_or_eo)
  {
	...
	if(paral_dir[v])
	  {
	    ...
	    BI_32_64_HALFSPINCOLOR *base_out=(BI_32_64_HALFSPINCOLOR*)send_buf+(bord_volh+0*8*vdir_bord_vol)/fact;
	    BI_32_64_HALFSPINCOLOR *base_vdir_in=(BI_32_64_HALFSPINCOLOR*)send_buf+(bord_volh+8*loc_volh+1*vbord_vol/2)/fact;
	    BI_32_64_HALFSPINCOLOR *base_bord_in=(BI_32_64_HALFSPINCOLOR*)recv_buf+bord_offset[v]/2/fact;
	    
	    NISSA_CHUNK_LOOP(isrc,0,vdir_bord_vol/2/fact,thread_in_team_id,nthreads_in_team)
	      {
		//VN=0 must be filled with border
		DECLARE_REG_BI_HALFSPINCOLOR(in0);
		REG_LOAD_BI_32_64_HALFSPINCOLOR(in0,base_bord_in[isrc]);
		//VN=1 with buf0
		DECLARE_REG_BI_HALFSPINCOLOR(in1);
		REG_LOAD_BI_32_64_HALFSPINCOLOR(in1,base_vdir_in[2*isrc]);
		//merge and save
		DECLARE_REG_BI_HALFSPINCOLOR(to_dest);
		REG_BI_HALFSPINCOLOR_V0_MERGE(to_dest,in0,in1);
		STORE_REG_BI_32_64_HALFSPINCOLOR(base_out[2*isrc*8+4+v],to_dest);
		
		//VN=1 with buf1
		REG_LOAD_BI_32_64_HALFSPINCOLOR(in1,base_vdir_in[2*isrc+1]);
		//merge and save
		REG_BI_HALFSPINCOLOR_V10_MERGE(to_dest,in0,in1);
		STORE_REG_BI_32_64_HALFSPINCOLOR(base_out[(2*isrc+1)*8+4+v],to_dest);
	      }
	  }
	...
	for(int imu=0;imu<3;imu++)
	  {
	    ...
	    BI_32_64_HALFSPINCOLOR *base_out=(BI_32_64_HALFSPINCOLOR*)send_buf+bord_volh/fact;
	    BI_32_64_HALFSPINCOLOR *base_in=(BI_32_64_HALFSPINCOLOR*)recv_buf;
	...
	if(paral_dir[v])
	  {
	    //inside incoming borders vdir is ordered naturally, while in the output data it comes first
	    BI_32_64_HALFSPINCOLOR *base_out=(BI_32_64_HALFSPINCOLOR*)send_buf+(bord_volh+1*8*vdir_bord_vol)/fact;
	    BI_32_64_HALFSPINCOLOR *base_vdir_in=(BI_32_64_HALFSPINCOLOR*)send_buf+(bord_volh+8*loc_volh+0*vbord_vol/2)/fact;
	    BI_32_64_HALFSPINCOLOR *base_bord_in=(BI_32_64_HALFSPINCOLOR*)recv_buf+(bord_vol/4+bord_offset[v]/2)/fact;
	    
	    NISSA_CHUNK_LOOP(isrc,0,vdir_bord_vol/2/fact,thread_in_team_id,nthreads_in_team)
	      {
		//VN=0 with buf1
		DECLARE_REG_BI_HALFSPINCOLOR(in0);
		REG_LOAD_BI_32_64_HALFSPINCOLOR(in0,base_vdir_in[2*isrc]);
		//VN=1 must be filled with border 0
		DECLARE_REG_BI_HALFSPINCOLOR(in1);
		REG_LOAD_BI_32_64_HALFSPINCOLOR(in1,base_bord_in[isrc]);
		//merge and save
		DECLARE_REG_BI_HALFSPINCOLOR(to_dest);
		REG_BI_HALFSPINCOLOR_V10_MERGE(to_dest,in0,in1);
		STORE_REG_BI_32_64_HALFSPINCOLOR(base_out[2*isrc*8+0+v],to_dest);
		
		//VN=0 with buf1
		REG_LOAD_BI_32_64_HALFSPINCOLOR(in0,base_vdir_in[2*isrc+1]);
		//merge and save
		REG_BI_HALFSPINCOLOR_V1_MERGE(to_dest,in0,in1);
		STORE_REG_BI_32_64_HALFSPINCOLOR(base_out[(2*isrc+1)*8+0+v],to_dest);
	      }
	  }
...
#undef BI_32_64_SPINCOLOR
#undef BI_32_64_HALFSPINCOLOR
#undef BI_32_64_SU3
...
#undef REG_LOAD_BI_32_64_SPINCOLOR_ADVANCING
#undef REG_LOAD_BI_32_64_SPINCOLOR
#undef STORE_REG_BI_32_64_SPINCOLOR
#undef STORE_REG_BI_32_64_SPINCOLOR_ADVANCING
#undef REG_LOAD_BI_32_64_HALFSPINCOLOR
#undef STORE_REG_BI_32_64_HALFSPINCOLOR
#undef BI_32_64_HALFSPINCOLOR_PREFETCH_NEXT
#undef REG_BI_32_64_SU3_PROD_BI_32_64_HALFSPINCOLOR_LOAD_STORE
#undef DER_TMQ_EXP_BGQ_32_64_HEADER
#undef REG_BI_32_64_SU3_DAG_PROD_BI_32_64_HALFSPINCOLOR_LOAD_STORE
