...
#define REG_BI_HALFSPINCOLOR_TRANSPOSE(out,in) REG_BI_HALFSPINCOLOR_PERM(out,in,in,V_TRANSPOSE);

#define REG_BI_COLOR_V0_MERGE(out,in1,in2) REG_BI_COLOR_PERM(out,in1,in2,V0_MERGE);
#define REG_BI_COLOR_V1_MERGE(out,in1,in2) REG_BI_COLOR_PERM(out,in1,in2,V1_MERGE);
#define REG_BI_COLOR_V10_MERGE(out,in1,in2) REG_BI_COLOR_PERM(out,in1,in2,V10_MERGE);
#define REG_BI_COLOR_V01_MERGE(out,in1,in2) REG_BI_COLOR_PERM(out,in1,in2,V01_MERGE);
#define REG_BI_COLOR_TRANSPOSE(out,in) REG_BI_COLOR_PERM(out,in,in,V_TRANSPOSE)
