...
MPI_Datatype MPI_EO_GAUGE_BORD_SEND_TXY[4],MPI_EV_GAUGE_BORD_SEND_Z[2],MPI_EO_GAUGE_BORD_RECE[4];
MPI_Datatype MPI_EO_COLOR_BORD_SEND_TXY[4],MPI_EV_COLOR_BORD_SEND_Z[2],MPI_EO_COLOR_BORD_RECE[4];
MPI_Datatype MPI_EO_SPINCOLOR_BORD_SEND_TXY[4],MPI_EV_SPINCOLOR_BORD_SEND_Z[2],MPI_EO_SPINCOLOR_BORD_RECE[4];
