...
void apply_Q2_RL(spincolor *out,spincolor *in,quad_su3 *conf,double kappa,double mu,spincolor *temp,int RL)
{
  int all=0;
...
{apply_Q2_RL(out,in,conf,kappa,mu,temp,0);}

void apply_Q2_left(spincolor *out,spincolor *in,quad_su3 *conf,double kappa,double mu,spincolor *temp)
{apply_Q2_RL(out,in,conf,kappa,mu,temp,1);}
