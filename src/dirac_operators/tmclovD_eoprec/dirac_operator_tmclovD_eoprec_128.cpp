...
namespace nissa
{
  ...
  THREADABLE_FUNCTION_4ARG(tmclovn2Deo_or_tmclovn2Doe_eos_128, spincolor_128*,out, quad_su3**,conf, int,eooe, spincolor_128*,in)
  {
  ...
  //wrappers
  void tmclovn2Doe_eos_128(spincolor_128 *out,quad_su3 **conf,spincolor_128 *in){tmclovn2Deo_or_tmclovn2Doe_eos_128(out,conf,1,in);}
  void tmclovn2Deo_eos_128(spincolor_128 *out,quad_su3 **conf,spincolor_128 *in){tmclovn2Deo_or_tmclovn2Doe_eos_128(out,conf,0,in);}
  
  //implement ee or oo part of Dirac operator, equation(3)
  THREADABLE_FUNCTION_4ARG(tmclovDee_or_oo_eos_128, spincolor_128*,out, double,kappa, double,mu, spincolor_128*,in)
  {
  ...
  //inverse
  THREADABLE_FUNCTION_4ARG(inv_tmclovDee_or_oo_eos_128, spincolor_128*,out, double,kappa, double,mu, spincolor_128*,in)
  {
  ...
  THREADABLE_FUNCTION_6ARG(tmclovDkern_eoprec_eos_128, spincolor_128*,out, spincolor_128*,temp, quad_su3**,conf, double,kappa, double,mu, spincolor_128*,in)
  {
    tmclovn2Deo_eos_128(out,conf,in);
    inv_tmclovDee_or_oo_eos_128(temp,kappa,mu,out);
    tmclovn2Doe_eos_128(out,conf,temp);
    tmclovDee_or_oo_eos_128(temp,kappa,mu,in);
  ...
  //square of Koo
  void tmclovDkern_eoprec_square_eos_128(spincolor_128 *out,spincolor_128 *temp1,spincolor_128 *temp2,quad_su3 **conf,double kappa,double mu,spincolor_128 *in)
  {
    tmclovDkern_eoprec_eos_128(temp1,temp2,conf,kappa,-mu, in   );
    tmclovDkern_eoprec_eos_128(out,  temp2,conf,kappa,+mu, temp1);
  }
}
