...
namespace nissa
{
  //Apply the Q=g5*(Dwilson + A*Id)  operator to a spincolor. (We modified tmQ_portable)
  //
  ...
  //
  THREADABLE_FUNCTION_4ARG(apply_H, spincolor*,out, quad_su3*,conf, double,kappa, spincolor*,in)
  {
