...
*/
  ...
  //square of Koo
  void tmDkern_eoprec_square_eos_bgq(bi_spincolor *out,bi_oct_su3 **conf,double kappa,double mass,bi_spincolor *in)
  {
    //tmDkern_eoprec_eos_bgq(out,conf,kappa,-mu, in);
    //tmDkern_eoprec_eos_bgq(out,conf,kappa,+mu,out);
  }
}
