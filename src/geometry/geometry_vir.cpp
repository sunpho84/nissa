...
namespace nissa
{
  ...
  //   //copy the various VN
  //   NISSA_PARALLEL_LOOP(ivol_lx,0,loc_vol)
  //     COLOR_TO_VIR_COLOR(out[loclx_parity[ivol_lx]][vireo_of_loclx[ivol_lx]],in[ivol_lx],vrank_of_loclx(ivol_lx));
  ...
  //   //copy the various VN
  //   NISSA_PARALLEL_LOOP(ivol_lx,0,loc_vol)
  //     COLOR_TO_VIR_SINGLE_COLOR(out[loclx_parity[ivol_lx]][vireo_of_loclx[ivol_lx]],in[ivol_lx],vrank_of_loclx(ivol_lx));
  ...
  //   for(int par=0;par<2;par++)
  //     NISSA_PARALLEL_LOOP(ivol_vireo,0,loc_volh/nvranks)
  // 	VIR_COLOR_TO_COLOR(out[loclx_of_vireo[par][ivol_vireo]],out[loclx_of_vireo[par][ivol_vireo]+vrank_lx_offset],
  // 			  in[par][ivol_vireo]);
  ...
  //   //split to the two VN
  //   NISSA_PARALLEL_LOOP(ivol_eo,0,loc_volh)
  //     COLOR_TO_VIR_COLOR(out[vireo_of_loceo[par][ivol_eo]],in[ivol_eo],vrank_of_loceo(EVN,ivol_eo));
  ...
  //   //split to the two VN
  //   NISSA_PARALLEL_LOOP(ivol_vireo,0,loc_volh/nvranks)
  //     VIR_COLOR_TO_COLOR(out[loceo_of_vireo[par][ivol_vireo]],out[loceo_of_vireo[par][ivol_vireo]+vrank_eo_offset],
  // 			in[ivol_vireo]);
  ...
  //   //split to the two VN
  //   NISSA_PARALLEL_LOOP(ivol_eo,0,loc_volh)
  //     COLOR_TO_VIR_SINGLE_COLOR(out[vireo_of_loceo[par][ivol_eo]],in[ivol_eo],vrank_of_loceo(EVN,ivol_eo));
  ...
  //   //split to the two VN
  //   NISSA_PARALLEL_LOOP(ivol_vireo,0,loc_volh/nvranks)
  //     VIR_SINGLE_COLOR_TO_COLOR(out[loceo_of_vireo[par][ivol_vireo]],out[loceo_of_vireo[par][ivol_vireo]+vrank_eo_offset],
  // 			       in[ivol_vireo]);
