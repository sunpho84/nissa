...
namespace nissa
{
  ...
  EXTERN_GEOMETRY_VIR coords fix_nvranks;
  
  EXTERN_GEOMETRY_VIR int vir_geom_inited;
  EXTERN_GEOMETRY_VIR int vrank_lx_offset,vrank_eo_offset;
  EXTERN_GEOMETRY_VIR int vloc_vol,vbord_vol,vbord_volh;
  EXTERN_GEOMETRY_VIR coords vloc_size,nvranks_per_dir;
  EXTERN_GEOMETRY_VIR int *vloclx_of_loclx,*loclx_of_vloclx;
  EXTERN_GEOMETRY_VIR int *loclx_of_vloceo[2],*vloceo_of_loclx;
  EXTERN_GEOMETRY_VIR int *vloceo_of_loceo[2],*loceo_of_vloceo[2];
