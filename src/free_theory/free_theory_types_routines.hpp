...
namespace nissa
{
  gauge_info create_tlSym_gauge_info(gauge_info::which_gauge_t which_gauge,const momentum_t& bc,double c1=-1.0/12);
  gauge_info create_Wilson_gauge_info(gauge_info::which_gauge_t which_gauge,const momentum_t& bc);
