...
namespace nissa
{
  double compute_quark_action(const OldEoField<quad_su3>& eo_conf,
			      const std::vector<OldEoField<quad_u1>*>& u1b,
  ...
  double full_theory_action(const OldEoField<quad_su3>& eo_conf,
			    const OldEoField<quad_su3>&  sme_conf,
			    const OldEoField<quad_su3>& H,
			    const std::vector<EvnField<pseudofermion_t>*>& pf,
