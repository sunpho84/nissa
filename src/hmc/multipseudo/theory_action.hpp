...
namespace nissa
{
  void compute_quark_action(double *glb_action,quad_su3 **eo_conf,int nfl,quad_u1 ***u1b, pseudofermion_t *pf,quark_content_t *quark_content,hmc_evol_pars_t *simul_pars);
