...
namespace nissa
{
  void compute_quark_action(double *glb_action,quad_su3 **eo_conf,int nfl,std::vector<quad_u1**> u1b, std::vector<std::vector<pseudofermion_t> > *pf,std::vector<quark_content_t> quark_content,hmc_evol_pars_t *simul_pars,std::vector<rat_approx_t> *rat_appr);
