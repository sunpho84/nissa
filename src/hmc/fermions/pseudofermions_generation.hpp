...
namespace nissa
{
  void generate_pseudo_fermion(double *action,pseudofermion_t *pf,quad_su3 **conf,clover_term_t *Cl_odd,inv_clover_term_t *invCl_evn,quad_u1 **u1b,rat_approx_t *rat,double residue,quark_content_t q);
