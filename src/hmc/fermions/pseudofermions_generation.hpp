...
namespace nissa
{
  ...
  double generate_pseudofermions(std::vector<std::vector<pseudofermion_t>> &pf,const EoField<quad_su3>& conf,theory_pars_t &theory_pars,hmc_evol_pars_t &simul_pars,std::vector<rat_approx_t> &rat_appr);
}
