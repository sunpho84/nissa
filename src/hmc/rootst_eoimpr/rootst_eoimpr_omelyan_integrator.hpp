...
namespace nissa
{
  ...
  void omelyan_rootst_eoimpr_evolver(quad_su3 **H,double *H_B,quad_su3 **conf,color **pf,color ***pf_B,theory_pars_t *theory_pars,rat_approx_t *appr,hmc_evol_pars_t *simul);
}
