...
namespace nissa
{
  ...
  void MFACC_momenta_action(double *out,su3 **pi,int naux_fields,quad_su3 *conf,double kappa);
  inline double MFACC_momenta_action(su3 **pi,int naux_fields,quad_su3 *conf,double kappa)
  {
    double out;
