...
namespace nissa
{
  void pass_spinspin_from_mom_to_x_space_source_or_sink(spinspin *out,spinspin *in,bool *dirs,double *bc,int source_or_sink);
  ...
  void pass_spinspin_from_x_to_mom_space_source_or_sink(spinspin *out,spinspin *in,bool *dirs,double *bc,int source_or_sink);
  ...
  void pass_spin1prop_from_mom_to_x_space(spin1prop *out,spin1prop *in,bool *dirs,double *bc,int source_or_sink);
  ...
  void pass_spin1prop_from_x_to_mom_space(spin1prop *out,spin1prop *in,bool *dirs,double *bc,int source_or_sink);
  ...
  void pass_spin1field_from_mom_to_x_space(spin1field *out,spin1field *in,bool *dirs,double *bc,int source_or_sink);
  ...
  void pass_spin1field_from_x_to_mom_space(spin1field *out,spin1field *in,bool *dirs,double *bc,int source_or_sink);
  ...
  void pass_spin_from_mom_to_x_space_source_or_sink(spin *out,spin *in,bool *dirs,double *bc,int source_or_sink);
  ...
  void pass_spin_from_x_to_mom_space_source_or_sink(spin *out,spin *in,bool *dirs,double *bc,int source_or_sink);
