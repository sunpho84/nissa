...
namespace nissa
{
  void pass_spinspin_from_mom_to_x_space(spinspin *out,spinspin *in,int *dirs,double *bc);
  inline void pass_spinspin_from_mom_to_x_space(spinspin *out,spinspin *in,double *bc)
  {int dirs[4]={1,1,1,1};pass_spinspin_from_mom_to_x_space(out,in,dirs,bc);}
  void pass_spinspin_from_x_to_mom_space(spinspin *out,spinspin *in,int *dirs,double *bc);
  inline void pass_spinspin_from_x_to_mom_space(spinspin *out,spinspin *in,double *bc)
  {int dirs[4]={1,1,1,1};pass_spinspin_from_x_to_mom_space(out,in,dirs,bc);}
  ...
  inline void pass_spin_from_mom_to_x_space(spin *out,spin *in,double *bc,bool bar=false)
  {int dirs[4]={1,1,1,1};pass_spin_from_mom_to_x_space(out,in,dirs,bc,bar);}
  void pass_spin_from_x_to_mom_space(spin *out,spin *in,int *dirs,double *bc,bool bar=false);
  inline void pass_spin_from_x_to_mom_space(spin *out,spin *in,double *bc,bool bar=false)
  {int dirs[4]={1,1,1,1};pass_spin_from_x_to_mom_space(out,in,dirs,bc,bar);}
}
