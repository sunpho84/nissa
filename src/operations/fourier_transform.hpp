...
namespace nissa
{
  ...
  void pass_spin1prop_from_mom_to_x_space(spin1prop *out,spin1prop *in,int *all_dirs,double *bc);
  inline void pass_spin1prop_from_mom_to_x_space(spin1prop *out,spin1prop *in,double *bc)
  {pass_spin1prop_from_mom_to_x_space(out,in,all_dirs,bc);}
  void pass_spin1prop_from_x_to_mom_space(spin1prop *out,spin1prop *in,int *all_dirs,double *bc);
  inline void pass_spin1prop_from_x_to_mom_space(spin1prop *out,spin1prop *in,double *bc)
  {pass_spin1prop_from_x_to_mom_space(out,in,all_dirs,bc);}
  void pass_spin1field_from_mom_to_x_space(spin1field *out,spin1field *in,int *all_dirs,double *bc,bool bar=false);
  inline void pass_spin1field_from_mom_to_x_space(spin1field *out,spin1field *in,double *bc,bool bar=false)
  {pass_spin1field_from_mom_to_x_space(out,in,all_dirs,bc,bar);}
  void pass_spin1field_from_x_to_mom_space(spin1field *out,spin1field *in,int *all_dirs,double *bc,bool bar=false);
  inline void pass_spin1field_from_x_to_mom_space(spin1field *out,spin1field *in,double *bc,bool bar=false)
  {pass_spin1field_from_x_to_mom_space(out,in,all_dirs,bc,bar);}
