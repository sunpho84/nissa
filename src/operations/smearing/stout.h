#ifndef _STOUT_H
#define _STOUT_H
void stout_smear_whole_stack(quad_su3 ***out,quad_su3 **in,stout_pars_type *stout_pars);
void stout_smear(quad_su3 **ext_out,quad_su3 **ext_in,stout_pars_type *stout_pars);
void stout_smear_single_level(quad_su3 **out,quad_su3 **ext_in,stout_coeff_type rho);
