...
namespace nissa
{
  ...
  CUDA_HOST_DEVICE void stout_smear_compute_weighted_staples(su3 staples,eo_ptr<quad_su3> conf,int p,const LocEoSite& A,int mu,double rho)
  {
    //put staples to zero
  ...
  CUDA_HOST_DEVICE void stout_smear_compute_staples(stout_link_staples *out,eo_ptr<quad_su3> conf,int p,const LocEoSite& A,int mu,double rho)
  {
    //compute the staples
