...
namespace nissa
{
  ...
  struct spectral_proj_meas_pars_t : base_fermionic_meas_t
  {
    int neigs;
    ...
    {path=def_path();}
    virtual ~spectral_proj_meas_pars_t(){}
  };

  void measure_spectral_proj(quad_su3 **conf,theory_pars_t &theory_pars,spectral_proj_meas_pars_t &pars, int iconf,bool conf_created);
