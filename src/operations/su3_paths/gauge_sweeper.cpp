...
namespace nissa
{
  ...
  void gauge_sweeper_t::init_box_dir_par_geometry(int ext_gpar,int(*par_comp)(Coords<int> ivol_coord,int dir))
  {
    ...
    // 		if(site_par==par)
    // 		  {
    // 		    ivol_of_box_dir_par[ibox_dir_par++]=lx_of_coord(ivol_coord,locSize);
