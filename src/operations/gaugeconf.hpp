...
namespace nissa
{
  ...
  void cool_eo_conf(quad_su3 **eo_conf,gauge_action_name_t gauge_action_name,int over_flag,double over_exp);
  void cool_lx_conf(quad_su3 *lx_conf,gauge_action_name_t gauge_action_name,int over_flag,double over_exp);
