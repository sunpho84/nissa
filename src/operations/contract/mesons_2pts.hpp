...
namespace nissa
{
  ...
  void meson_two_points_Wilson_prop(complex *corr,complex *loc_corr,int *list_op1,su3spinspin *s1,int *list_op2,su3spinspin *s2,int ncontr);
  void meson_two_points_Wilson_prop(complex *corr,complex* loc_corr,int *list_op1,colorspinspin *s1,int *list_op2,colorspinspin *s2,int ncontr);
}
