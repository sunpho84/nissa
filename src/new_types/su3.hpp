...
namespace nissa
{
  ...
  inline void unsafe_su3_prod_su3(su3 a,su3 b,su3 c,int nr_max=3)
  {
  ...
  //Product of two su3 matrixes
  inline void unsafe_su3_dag_prod_su3(su3 a,su3 b,su3 c,int nr_max=3)
  {
    for(int ir_out=0;ir_out<nr_max;ir_out++)
      for(int ic_out=0;ic_out<3;ic_out++)
	{
  ...
  //Product of two su3 matrixes
  inline void unsafe_su3_prod_su3_dag(su3 a,su3 b,su3 c,int nr_max=3)
  {
    for(int ir_out=0;ir_out<nr_max;ir_out++)
      for(int ic_out=0;ic_out<3;ic_out++)
	{
  ...
  //Product of two su3 matrixes
  inline void unsafe_su3_dag_prod_su3_dag(su3 a,su3 b,su3 c,int nr_max=3)
  {
    for(int ir_out=0;ir_out<nr_max;ir_out++)
      for(int ic_out=0;ic_out<3;ic_out++)
	{
  ...
  //overrelax the link
  inline void su3_overrelax(su3 out,su3 in,double w,double *coeff,const int ord)
  {
    su3 t[ord];
  ...
  inline void su3_find_heatbath(su3 out,su3 in,su3 staple,double beta,int nhb_hits,rnd_gen *gen)
  {
  ...
  inline void su3_find_overrelaxed(su3 out,su3 in,su3 staple,int nov_hits)
  {
    //compute the original contribution to the action due to the given link 
    su3 prod;
    unsafe_su3_prod_su3_dag(prod,in,staple);
  ...
  inline void su3_find_cooled(su3 u,quad_su3 **eo_conf,int par,int ieo,int mu)
  {
    //compute the staple
    su3 staple;
