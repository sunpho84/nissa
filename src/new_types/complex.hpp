...
namespace nissa
{
  ...
  //Assign
  inline void complex_copy(complex a,const complex b)
  {
    a[0]=b[0];
    a[1]=b[1];
  }
  ...
  inline void complex_put_to_real(complex a,const double b)
  {
    a[0]=b;
    a[1]=0;
  }
  ...
  //Assign the conj
  inline void complex_conj(complex a,const complex b)
  {
    a[0]=b[0];
    a[1]=-b[1];
  }
  ...
  inline void complex_summ(complex a,const complex b,const complex c)
  {
    a[0]=b[0]+c[0];
    a[1]=b[1]+c[1];
  }
  inline void complex_isumm(complex a,const complex b,const complex c)
  {
    a[0]=b[0]-c[1];
    a[1]=b[1]+c[0];
  }
  ...
  {complex_isumm(a,a,b);}
  inline void complex_summ_conj2(complex a,const complex b,const complex c)
  {
    a[0]=b[0]+c[0];
    a[1]=b[1]-c[1];
  }
  ...
  inline void complex_subt(complex a,const complex b,const complex c)
  {
    a[0]=b[0]-c[0];
    a[1]=b[1]-c[1];
  }
  inline void complex_isubt(complex a,const complex b,const complex c)
  {
    a[0]=b[0]+c[1];
    a[1]=b[1]-c[0];
  }
  ...
  {complex_isubt(a,a,b);}
  inline void complex_subt_conj2(complex a,const complex b,const complex c)
  {
    a[0]=b[0]-c[0];
    a[1]=b[1]+c[1];
  }
  ...
  inline void complex_summassign(complex a,const complex b) {complex_summ(a,a,b);}
  inline void complex_subtassign(complex a,const complex b) {complex_subt(a,a,b);}
  
  //put to exp
  inline void complex_iexp(complex out,const double arg)
  {sincos(arg,out+IM,out+RE);}
  
  //prod with real
  inline void complex_prod_double(complex a,const complex b,const double c) {a[RE]=b[RE]*c;a[IM]=b[IM]*c;}
  inline void complex_prodassign_double(complex a,const double c) {complex_prod_double(a,a,c);}
  inline void complex_prod_idouble(complex a,const complex b,const double c) {const double d=-b[IM]*c;a[IM]=b[RE]*c;a[RE]=d;}
  ...
  inline void complex_summ_the_prod_idouble(complex a,const complex b,double c)
  {
  ...
  inline void complex_summ_the_prod(complex a,const complex b,const complex c)
  {
    const double t=b[0]*c[0]-b[1]*c[1];
    a[1]+=b[0]*c[1]+b[1]*c[0];
    a[0]+=t;
  }
  inline void single_complex_summ_the_prod(single_complex a,const single_complex b,const single_complex c)
  {
    const double t=b[0]*c[0]-b[1]*c[1];
    a[1]+=b[0]*c[1]+b[1]*c[0];
    a[0]+=t;
  }
  inline void complex_subt_the_prod(complex a,const complex b,const complex c)
  {
    const double t=b[0]*c[0]-b[1]*c[1];
    a[1]-=b[0]*c[1]+b[1]*c[0];
    a[0]-=t;
  }
  inline void complex_summ_the_conj2_prod(complex a,const complex b,const complex c)
  {
    const double t=+b[0]*c[0]+b[1]*c[1];
    a[1]+=-b[0]*c[1]+b[1]*c[0];
    a[0]+=t;
  ...
  inline void complex_summ_the_conj1_prod(complex a,const complex b,const complex c)
  ...
  inline void complex_summ_the_conj_conj_prod(complex a,const complex b,const complex c)
  {
    const double t=+b[0]*c[0]-b[1]*c[1];
    a[1]+=-b[0]*c[1]-b[1]*c[0];
    a[0]+=t;
  }
  inline void complex_subt_the_conj2_prod(complex a,const complex b,const complex c)
  {
    const double t=+b[0]*c[0]+b[1]*c[1];
    a[1]-=-b[0]*c[1]+b[1]*c[0];
    a[0]-=t;
  }
  inline void single_complex_subt_the_conj2_prod(single_complex a,const single_complex b,const single_complex c)
  {
    const double t=+b[0]*c[0]+b[1]*c[1];
    a[1]-=-b[0]*c[1]+b[1]*c[0];
    a[0]-=t;
  }
  inline void complex_subt_the_conj1_prod(complex a,const complex b,const complex c)
  {complex_subt_the_conj2_prod(a,c,b);}
  inline void single_complex_subt_the_conj1_prod(single_complex a,const single_complex b,const single_complex c)
  {single_complex_subt_the_conj2_prod(a,c,b);}
  inline void complex_subt_the_conj_conj_prod(complex a,const complex b,const complex c)
  {
    const double t=+b[0]*c[0]-b[1]*c[1];
    a[1]-=-b[0]*c[1]-b[1]*c[0];
    a[0]-=t;
  ...
  inline void unsafe_complex_prod(complex a,const complex b,const complex c)
  {
    a[0]=b[0]*c[0]-b[1]*c[1];
    a[1]=b[0]*c[1]+b[1]*c[0];
  }  
  ...
  inline void unsafe_single_complex_prod(single_complex a,const single_complex b,const single_complex c)
  {
    a[0]=b[0]*c[0]-b[1]*c[1];
    a[1]=b[0]*c[1]+b[1]*c[0];
  }
  ...
  inline void unsafe_complex_conj2_prod(complex a,const complex b,const complex c)
  {
    a[0]=+b[0]*c[0]+b[1]*c[1];
    a[1]=-b[0]*c[1]+b[1]*c[0];
  }
  ...
  //Swapped order
  inline void unsafe_complex_conj1_prod(complex a,const complex b,const complex c)
  ...
  inline void unsafe_complex_conj_conj_prod(complex a,const complex b,const complex c)
  {
    a[0]=+b[0]*c[0]-b[1]*c[1];
    a[1]=-b[0]*c[1]-b[1]*c[0];
  }
  ...
  //The product of two complex number
  inline void safe_complex_prod(complex a,const complex b,const complex c)
  {
  ...
  //complex prod i
  inline void safe_complex_prod_i(complex a,const complex b)
  {
  ...
  //complex prod -i
  inline void safe_complex_prod_minus_i(complex a,const complex b)
  {
    const double tmp=b[0];
    a[0]=b[1];
    a[1]=-tmp;
  ...
  //squared norm
  inline double complex_norm2(const complex c)
  {return c[0]*c[0]+c[1]*c[1];}
  
  //reciprocal of a complex
  inline void complex_reciprocal(complex rec,const complex c)
  {
  ...
  //power of a complex
  inline void complex_pow(complex res,const complex base,const double exp)
  {
