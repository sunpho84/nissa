...
namespace nissa
{
  ...
  void inv_tmclovD_cg_eoprec_native(LxField<spincolor>& solution_lx,
				    const OddField<spincolor>* guess_Koo,
				    const LxField<quad_su3>& conf_lx,
				    const double& kappa,
				    const double& cSW,
				    const LxField<clover_term_t>& Cl_lx,
				    LxField<inv_clover_term_t>* ext_invCl_lx,
				    const double& mass,
				    const int& nitermax,
				    ...
				    const LxField<spincolor>& source_lx)
  {
    ...
    LxField<inv_clover_term_t> *invCl_lx;
    if(ext_invCl_lx) invCl_lx=ext_invCl_lx;
    else
      {
	invCl_lx=new LxField<inv_clover_term_t>("invCl");
