...
namespace nissa
{
  void inv_tmclovQ2_cg_128_bgq(bi_spincolor *sol,bi_spincolor *guess,bi_oct_su3 *conf,double kappa,bi_clover_term_t *Cl,double mass,int niter,double external_solver_residue,bi_spincolor *external_source);
