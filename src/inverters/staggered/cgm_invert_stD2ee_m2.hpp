...
namespace nissa
{
  inline void summ_src_and_all_inv_stD2ee_m2_cgm(EvnField<color>& chi_e,
  ...
  inline void inv_stD2ee_m2_cgm_run_hm_up_to_comm_prec(std::vector<EvnField<color>>& chi_e,
						       const EoField<quad_su3>& eo_conf,
