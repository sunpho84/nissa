...
namespace nissa
{
  ...
  void inv_tmQ2_RL_cg_128(spincolor *sol,spincolor *guess,quad_su3 *conf,double kappa,int RL,double mass,int niter,double external_solver_residue,spincolor *external_source);
}
