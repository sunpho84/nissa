...
#define APPLY_OPERATOR_128 apply_tmQ2_128
#define APPLY_OPERATOR apply_tmQ2
//parameters of the operator
#define CG_OPERATOR_128_PARAMETERS conf,kappa,temp_128,mass,

//name of the inverter, externally accedable
#define CG_128_INVERT inv_tmQ2_cg_128
...
#define CG_128_INNER_SOLVER inv_tmQ2_cg_64
//parameters of the inner solver
#define CG_128_INNER_PARAMETERS_CALL conf,kappa,mass,
