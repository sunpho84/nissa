...
namespace nissa
{
  ...
  inline void complex_vector_self_conj(complex *v,int64_t n)
  {complex_vector_conj(v,v,n);}
  void complex_vector_glb_scalar_prod(double *glb_res,complex *a,complex *b,int64_t n);
  void complex_vector_summassign_complex_vector_prod_complex(complex *a,complex *b,complex c,int64_t n);
  inline void complex_vector_subtassign_complex_vector_prod_complex(complex *a,complex *b,complex c,int64_t n)
  {
    complex d={-c[RE],-c[IM]};
  ...
  void double_vector_glb_scalar_prod(double *res,double *a,double *b,int64_t n);
  
  template <class T> double double_vector_glb_norm2(T *v,int64_t n_per_class)
  ...
  void vector_loc_norm2(TOut *loc_norm2,TIn *v,int64_t n_per_class)
  {
  ...
  void single_vector_glb_scalar_prod(float *res,float *a,float *b,int64_t n);
  ...
  void double_vector_linear_comb(double *a,double *b,double c,double *d,double e,int64_t n,int OPT=0);
  void single_vector_linear_comb(float *a,float *b,float c,float *d,float e,int64_t n,int OPT=0);
  void double_vector_prod_double(double *out,double *in,double r,int64_t n);
  inline void double_vector_prodassign_double(double *v,double r,int64_t n)
  ...
  void double_vector_subt(double *out,double *in1,double *i2,int64_t n);
  void double_vector_summ(double *out,double *in1,double *i2,int64_t n);
  inline void double_vector_summassign(double *out,double *in,int64_t n){double_vector_summ(out,out,in,n);}
  inline void double_vector_subtassign(double *out,double *in,int64_t n){double_vector_subt(out,out,in,n);}
  void double_vector_summ_double_vector_prod_double(double *a,double *b,double *c,double d,int64_t n,int OPT=0);
  inline void double_vector_summassign_double_vector_prod_double(double *a,double *b,double c,int64_t n,int OPT=0)
  ...
  void single_vector_summ_single_vector_prod_single(float *a,float *b,float *c,float d,int64_t n,int OPT=0);
  ...
  void get_color_from_su3(eo_ptr<color> out,eo_ptr<su3> in,int ic);
  ...
  void put_color_into_su3(eo_ptr<su3> out,eo_ptr<color> in,int ic);
  ...
  void quadruple_vector_glb_scalar_prod(float_128 a,float_128 *b,float_128 *c,int64_t n);
