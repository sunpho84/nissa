...
#define FOR_COMPONENT_VALUES_IN_RANGE(TYPE,NAME,MIN,MAX)		\
  for(TYPE NAME=MIN;NAME<MAX;NAME++)
  
#define UNROLL_FOR_COMPONENT_VALUES_IN_RANGE(TYPE,NAME,MIN,MAX) \
  UNROLL_FOR(TYPE,NAME,MIN,MAX)
  
#define FOR_ALL_COMPONENT_VALUES_STARTING_AT(TYPE,NAME,MIN)	\
  FOR_COMPONENT_VALUES_IN_RANGE(TYPE,NAME,MIN,TYPE::sizeAtCompileTimeAssertingNotDynamic())
  
#define UNROLL_FOR_ALL_COMPONENT_VALUES_STARTING_AT(TYPE,NAME,MIN)	\
  UNROLL_FOR_COMPONENT_VALUES_IN_RANGE(TYPE,NAME,MIN,TYPE::sizeAtCompileTimeAssertingNotDynamic())
  
#define FOR_ALL_COMPONENT_VALUES(TYPE,NAME)			\
  FOR_ALL_COMPONENT_VALUES_STARTING_AT(TYPE,NAME,0)
  
#define UNROLL_FOR_ALL_COMPONENT_VALUES(TYPE,NAME)			\
  UNROLL_FOR_ALL_COMPONENT_VALUES_STARTING_AT(TYPE,NAME,0)
