...
namespace nissa
{
  ...
  void measure_watusso(watusso_meas_pars_t* pars,eo_ptr<quad_su3> eo_conf,int iconf,int create_output_file)
  {
    ...
    // 	      su3_trace(loc_res[ivol.nastyConvert()],small_su3[ivol.nastyConvert()]);
    ...
    // 		//trace it
    // 		NISSA_PARALLEL_LOOP(ivol,0,locVol)
    // 		  su3_trace(loc_res[ivol.nastyConvert()],big_su3[ivol.nastyConvert()]);
    // 		NISSA_PARALLEL_LOOP_END;
    // 		THREAD_BARRIER();
    // 		complex big_trace;
    ...
    // 			      //trace it
    // 			      NISSA_PARALLEL_LOOP(ivol,0,locVol)
    // 				trace_su3_prod_su3(loc_res[ivol.nastyConvert()],periscoped[ivol.nastyConvert()],big_su3[ivol.nastyConvert()]);
    // 			      NISSA_PARALLEL_LOOP_END;
    // 			      //wait and collapse
    // 			      THREAD_BARRIER();
    ...
    // 				{
    // 				  complex p,b;
    // 				  su3_trace(p,periscoped[ivol.nastyConvert()]);
    // 				  su3_trace(b,big_su3[ivol.nastyConvert()]);
    // 				  unsafe_complex_prod(loc_res[ivol.nastyConvert()],p,b);
    // 				}
    // 			      NISSA_PARALLEL_LOOP_END;
    // 			      //wait and collapse
    // 			      THREAD_BARRIER();
