...
#define NISSA_PARALLEL_LOOP_CUDA(INDEX,EXT_START,EXT_END) cuda_parallel_for(__LINE__,__FILE__,EXT_START,EXT_END,[=] __host__ __device__ (const uint64_t& INDEX){
#define NISSA_PARALLEL_LOOP_END_CUDA })
