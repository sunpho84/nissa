//decompress 8 parameters to an su3 matrix
{
  ...
  float rep_N=rsqrtf(help);
  
  help=(help<1) ? sqrtf(1-help) : 0; //a1
  ...
  help=((help=1-out[0][0][0]*out[0][0][0]-out[0][0][1]*out[0][0][1]-out[1][0][0]*out[1][0][0]-out[1][0][1]*out[1][0][1])>0) ? sqrtf(help) : 0;
